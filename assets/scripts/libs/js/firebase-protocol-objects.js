...
FB_PROTOCOL.PingPacket = function () {
	this.classId = function () {
		return FB_PROTOCOL.PingPacket.CLASSID;
	};
...
FB_PROTOCOL.ServiceTransportPacket = function () {
	this.classId = function () {
		return FB_PROTOCOL.ServiceTransportPacket.CLASSID
	};
	this.pid = {};
	this.seq = {};
	this.service = {};
...
FB_PROTOCOL.LocalServiceTransportPacket = function () {
	this.classId = function () {
		return FB_PROTOCOL.LocalServiceTransportPacket.CLASSID
	};
	this.seq = {};
	this.servicedata = [];
};
