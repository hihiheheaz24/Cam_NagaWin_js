...
cc.Class({
    ...
    setInfo() {
        ...
        if(this.dataPM.length > 1){
            this.listBtnTabL.node.active = true;
            this.listItemShop.getComponent(cc.Widget).left = 240;
            this.listItemShop.getComponent(cc.Widget).top = 163;
        }
        else{
            this.listBtnTabL.node.active = false;
            this.listItemShop.getComponent(cc.Widget).left = 30;
            this.listItemShop.getComponent(cc.Widget).top = 130;
        }
        this.updateChip();
    },
    start() {
